        ...
        <div class="container-fluid">
          ...
          <table class="table">
            <form action="/categories/store" method="POST">
                <?php echo csrf_field(); ?>
                <input class="w-100 mt-3" type="text" name="nama" placeholder="Nama Category">
...
</html><?php /**PATH C:\xampp\htdocs\laravelsanber2\resources\views/categories/create.blade.php ENDPATH**/ ?>