        ...
        <div class="container-fluid">
          ...
          <table class="table">
            <form action="/categories/<?php echo e($category->id); ?>" method="POST">
                ...
                <input class="w-100 mt-3" type="text" name="nama" placeholder="Nama Category" value="<?php echo e($category->nama); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\laravelsanber2\resources\views/categories/update.blade.php ENDPATH**/ ?>