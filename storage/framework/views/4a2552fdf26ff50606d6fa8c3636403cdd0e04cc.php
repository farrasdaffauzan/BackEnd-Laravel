    ...
    <nav class="navbar fixed-top navbar-expand-lg bg-body-tertiary">
      ...
      <section style="top: 100px" class="position-relative w-75 m-auto">
        <div class="container-fluid">
                ...
                <tr>
                  ...
                  <div class="d-flex flex-box">
                      <td class="d-flex flex-box">
                        ...
                        <a href="<?php echo e(route('categories.books', $item->id)); ?>" class="btn btn-outline-success m-1">View Book</a>
                      </td>
                  </div>
          ...
          <a href="<?php echo e(route('categoriesall.books')); ?>" class="btn btn-outline-success m-1">View all Book</a>
      </section>
